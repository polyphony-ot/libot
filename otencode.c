...
// more info.
static void append_str(char** buf, size_t* const bufsize, size_t* const written,
                       const char* const str, const size_t strsize) {
    *bufsize += strsize;
...
static void append_fmtstr(char** buf, size_t* const bufsize,
                          size_t* const written, const char* const fmt, ...) {
    va_list args;
    va_start(args, fmt);
